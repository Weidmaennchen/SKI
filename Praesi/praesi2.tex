...
\frame{
	...
	\begin{center}
    \includegraphics[width=0.7\textwidth]{images/databrokers.png}\cite{FTCStudy} % , height=0.7\textheight
    \end{center} 
}
\frame{
	\frametitle{Worth of Data Profiles}
	\begin{center}
    \includegraphics[width=0.7\textwidth]{images/dataworth.png}\cite{WorthofData} % , height=0.7\textheight
    \end{center} 
}
\frame{
...
\frame{
	\frametitle{Who is Gathering Data?}
	\begin{center}
    \includegraphics[width=0.7\textwidth]{images/gdrequest.png}\cite{FTCStudy} % , height=0.7\textheight
    \end{center} 
}
\frame{
