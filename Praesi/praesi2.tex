...
\frame{
	...
	\begin{center}
    \includegraphics[width=0.7\textwidth]{images/dpExample.png} % , height=0.7\textheight
    \end{center}
}
\frame{
	\frametitle{New permission models}
...
\frame{
	...
	\begin{center}
    \includegraphics[width=1\textwidth]{images/imExample.png} % , height=0.8\textheight
    \end{center}
}
\frame{
	\frametitle{New permission models}
...
\frame{
	...
	\begin{center}
    \includegraphics[width=0.8\textwidth]{images/fr1.png} % , height=0.8\textheight
    \end{center}
}
\frame{
	\frametitle{New permission models: FR}
	\begin{center}
    \includegraphics[width=0.8\textwidth]{images/fr2.png} % , height=0.8\textheight
    \end{center}
}
\frame{
	\frametitle{New permission models: FR}
	\begin{center}
    \includegraphics[width=0.8\textwidth]{images/fr3.png} % , height=0.8\textheight
    \end{center}
}
\frame{
	\frametitle{New permission models: FR}
	\begin{center}
    \includegraphics[width=0.8\textwidth]{images/fr4.png} % , height=0.8\textheight
    \end{center}
}
\frame{
	\frametitle{New permission models: FR}
	\begin{center}
    \includegraphics[width=0.8\textwidth]{images/fr5.png} % , height=0.8\textheight
    \end{center}
}
...
\frame{
	\frametitle{Permission model study}
	\begin{center}
    \includegraphics[width=1\textwidth]{images/alResults.png} % , height=0.8\textheight
    \end{center}
}
...
\frame{
	...
	Google Web Stores : 66 apps \vspace{5mm} \\
	Outside of Google Web Stores: 437 apps
}
\frame{
	\frametitle{Current misbehaviour of developers: How have the permissions changed?}
	\begin{center}
    \includegraphics[width=1\textwidth]{images/changeOfAccess.png} % , height=0.8\textheight
    \end{center}
}
\frame{
